...
function fetchProducts(page) {
    fetch(`http://localhost:8085/products/get/${categoryId}?page=${page}`, { // Sửa đường dẫn URL ở đây
        method: 'GET',
        headers: {
             'Authorization': 'Bearer ' + token,
...
function searchProduct() {
    ...
    fetch(`http://localhost:8085/products/search?keyword=${keyword}&category=${categoryId}`, {
        method: 'GET',
        headers: {
            'Authorization': 'Bearer ' + token,
            'Content-Type': 'application/json'
