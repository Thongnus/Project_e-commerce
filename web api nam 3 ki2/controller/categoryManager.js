...
function getCategories() {
    fetch('http://localhost:8085/admin/category',
        {
            method: 'GET',
            headers: {
...
function deleteCategory(id) {
    ...
    fetch(`http://localhost:8085/admin/category/delete/${id}`, {
        method: 'DELETE',
        headers: {
                'Authorization': 'Bearer ' + token,
            'Content-Type': 'application/json'
...
function addCategory() {
    ...
    fetch('http://localhost:8085/admin/category/add', {
        method: 'POST',
        headers: {
              'Authorization': 'Bearer ' + token,
            'Content-Type': 'application/json'
...
function updateCategory() {
    ...
    fetch(`http://localhost:8085/admin/category/update/${categoryId}`, {
        method: 'PUT',
        headers: {
            'Authorization': 'Bearer ' + token,
            'Content-Type': 'application/json'
...
function searchByUsername() {
    ...
    fetch(`http://localhost:8085/admin/category/search?keyword=${searchInput}`,
        {
            method: 'GET',
            headers: {
                'Authorization': 'Bearer ' + token,
