...
function addNew() {
    ...
    fetch('http://localhost:8085/api-new/add_new', {
        method: 'POST',
        headers: {
...
function fetchNews() {
    fetch('http://localhost:8085/api-new',{
            method: 'GET',
            headers: {
                'Authorization': 'Bearer ' + token,
...
function sendUpdateRequest(formData, newsId) {
    fetch(`http://localhost:8085/api-new/update_new/${newsId}`, {
        method: 'PUT',
        headers: {
            'Authorization': 'Bearer ' + token,
        },
...
function deleteRow(newsId) {
    ...
    fetch(`http://localhost:8085/api-new/${newsId}`, {
        method: 'DELETE',
        headers: {
            'Authorization': 'Bearer ' + token,
            'Content-Type': 'application/json'
...
function searchNews() {
    ...
    fetch(`http://localhost:8085/api-new/search?keyword=${searchInput}`, {
        method: 'GET',
        headers: {
            'Authorization': 'Bearer ' + token,
            'Content-Type': 'application/json',
